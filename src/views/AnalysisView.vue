...
import ImageDownloadMenu from '@/components/Global/Analysis/ImageDownloadMenu.vue'
import FitsHeaderTable from '@/components/Global/Analysis/FitsHeaderTable.vue'
import ImageViewer from '@/components/Global/Analysis/ImageViewer.vue'
import LinePlot from '@/components/Global/Analysis/LinePlot.vue'
